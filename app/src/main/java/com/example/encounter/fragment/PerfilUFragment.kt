...
import kotlinx.android.synthetic.main.fragment_perfil.view.following_button
 ...
 * Use the [PerfilUFragment.newInstance] factory method to
...
class PerfilUFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view =  inflater.inflate(R.layout.fragment_perfilu, container, false)
    ...
    companion object {
         ...
         * @return A new instance of fragment PerfilUFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            PerfilUFragment().apply {
